...
public class Action extends BaseClass {
	...
	// create object of action class to click on element
	...
	public static boolean isDisplayed(WebDriver ldriver, WebElement ele) throws
		boolean flag = false;
	...
	public static Object isDisplayed(WebDriver driver, WebElement mystorelogo) {
		boolean flag = false;
		try {
			flag = ele.isDisplayed(); 38
	}
}
